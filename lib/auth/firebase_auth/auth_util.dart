...
DocumentReference? get currentUserReference =>
    loggedIn ? UserBoughtTicketsRecord.collection.doc(currentUser!.uid) : null;

UserBoughtTicketsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserBoughtTicketsRecord.getDocument(
                  UserBoughtTicketsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
